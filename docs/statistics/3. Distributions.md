...
![distribution-normal.jpg](https://github.com/do2blehelix/the-ml-handbook/blob/master/assets/images/distribution-normal.jpg?raw=true)
...
![](\assets\images\distribution-uniform.png)

Consists of similar values throughout

## Skewed Distribution

![](/images/distribution-uniform.png)
