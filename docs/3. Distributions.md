...
**Normal / Gaussian / Continuous** Distribution : data distributed symmetrically around the centre `skewness = kurtosis = 0`. <br>
...
>To convert any dataset with any mean & std deviation to a dataset with mean = 0 & std dev = 1. <br>
